...
def save_data_to_csv(data):
    if data:
        ...
        output_file = f"leparking_part5_output_data_{current_date}.csv"
...
def main():
    print("Running main")
    url_list_file = "D:\\Oct_leparking\\scripts\\URL_park_long_part5.xlsx"
    fallback_url_list_file = "D:\\Oct_leparking\\URL_park_long_part5.xlsx"  # Path to fallback URL list
    suffix = "part5"
    ...
    driver = setup_driver()
    output_file = f"leparking_part5_output_data_{datetime.now().strftime('%Y%m%d')}.csv"  # One file per day
